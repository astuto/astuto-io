        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded border shadow-lg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Roadmap</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded border shadow-lg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Simple Sign In</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded border shadow-lg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Brand</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded border shadow-lg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Languages</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded border shadow-lg">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Notify</h4>
